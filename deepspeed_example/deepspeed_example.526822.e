...
No ROCm runtime is found, using ROCM_HOME='/opt/rocm'
No ROCm runtime is found, using ROCM_HOME='/opt/rocm'
2024-10-14 00:20:16.013 | INFO     | __main__:log_dist:54 - [Rank 0] Creating Experiment Directory
2024-10-14 00:20:16.295 | INFO     | __main__:log_dist:54 - [Rank 0] Experiment Directory created at /users/zhu/DeepSpeedExamples/training/HelloDeepSpeed/experiment_deepspeed/bert_pretrain.2024.10.13.15.20.16.addjtvxg
2024-10-14 00:20:16.298 | INFO     | __main__:log_dist:54 - [Rank 0] Creating Datasets
2024-10-14 00:20:21.481 | INFO     | __main__:log_dist:54 - [Rank 0] Dataset Creation Done
2024-10-14 00:20:21.481 | INFO     | __main__:log_dist:54 - [Rank 0] Creating Model
2024-10-14 00:20:21.810 | INFO     | __main__:log_dist:54 - [Rank 0] Model Creation Done
2024-10-14 00:20:21.810 | INFO     | __main__:log_dist:54 - [Rank 0] Creating DeepSpeed engine
...
Traceback (most recent call last):
  File "/users/zhu/anaconda3/lib/python3.12/site-packages/deepspeed/ops/adam/cpu_adam.py", line 102, in __del__
AttributeError: 'DeepSpeedCPUAdam' object has no attribute 'ds_opt_adam'
[rank1]:[W1014 00:20:45.223072314 ProcessGroupNCCL.cpp:1168] Warning: WARNING: process group has NOT been destroyed before we destruct ProcessGroupNCCL. On normal program exit, the application should call destroy_process_group to ensure that any pending NCCL operations have finished in this process. In rare cases this process can exit before this point and block the progress of another member of the process group. This constraint has always been present,  but this warning has only been added since PyTorch 2.4 (function operator())
[rank0]:[W1014 00:20:45.347270424 ProcessGroupNCCL.cpp:1168] Warning: WARNING: process group has NOT been destroyed before we destruct ProcessGroupNCCL. On normal program exit, the application should call destroy_process_group to ensure that any pending NCCL operations have finished in this process. In rare cases this process can exit before this point and block the progress of another member of the process group. This constraint has always been present,  but this warning has only been added since PyTorch 2.4 (function operator())
