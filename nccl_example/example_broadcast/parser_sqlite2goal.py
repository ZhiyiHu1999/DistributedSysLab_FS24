                    ...
                    for channel_id, net_channel_events in gpu_event["net_events"].items():
                        ...
                        if node_place == "001":
                            ...
                            for i in range(net_send_event_pair_num):
                                slot = i % num_slots  ## 8 for broadcast
                                if send_depends_on_send_events[slot] == {}:
                                    send_depends_on_send_events[slot]["ts_end"] = gpu_event["timestamp_start"]
                                    send_depends_on_send_events[slot]["task_id"] = gpu_event_start_calc_id
                                ...
                                task_counter += 1
                                file.write(f'l{task_counter}: calc {net_event["ts_start"] - send_depends_on_send_events[slot]["ts_end"]}\n')
                                file.write(f"l{task_counter} requires l{send_depends_on_send_events[slot]['task_id']}\n")
                                ...
                                if (i + num_slots) >= net_send_event_pair_num:
                            ...
                            for i in range(net_recv_event_pair_num):
                                ...
                                if (i + num_slots) >= net_recv_event_pair_num:
                            ...
                            for i in range(net_recv_event_pair_num):
                                ...
                                send_depends_on_recv_events[i]["ts_end"]= net_event["ts_end"]
                                send_depends_on_recv_events[i]["task_id"] = task_counter
