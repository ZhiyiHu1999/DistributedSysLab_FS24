...
BASE_PATH="/users/zhu/DistributedSysLab_FS24/megatron_examples/clariden"
...
export NSYS_REPORT_DIR="/users/zhu/DistributedSysLab_FS24/megatron_examples/clariden/results/nsys_reports"
...
NSYS="\
       ...
       -s none \
       --output='${NSYS_REPORT_DIR}/nsys_report_%h_%p.nsys-rep' \
       "
# NSYS=""
