#!/bin/bash -l
#
#SBATCH --job-name="pytorch_example_siamese_network"
#SBATCH --time=02:10:00
#SBATCH --partition=amdrtx
#SBATCH --nodelist=ault[43-44]
#SBATCH --ntasks-per-node=2
#SBATCH --gpus-per-task=1    
#SBATCH --output=pytorch_example_siamese_network.%j.o
#SBATCH --error=pytorch_example_siamese_network.%j.e
#SBATCH --account=g34
...
npkit_run_tag="siamese_network"  # Tag of this NPKit run.
