...
export NPKIT_RUN_DIR="/users/zhu/DistributedSysLab_FS24/nccl_example/example_allgather/results/npkit_run"

# Tag of this NPKit run.
npkit_run_tag="job_example_allgather"
...
srun ./example_allgather | tee $npkit_result_dir/log.txt
